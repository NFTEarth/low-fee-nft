...
export const HeadingImage: React.FC<HeadingImage> = ({
  ...
  return (
    <div className="self-start overflow-hidden rounded-xl bg-gray-200 dark:bg-gray-900 xs:h-[11.25rem] xs:w-[11.25rem] lg:mx-auto lg:h-auto lg:w-full lg:self-center border-purple-400 border-2">
      {isLoading ? (
        <div
          role="status"
